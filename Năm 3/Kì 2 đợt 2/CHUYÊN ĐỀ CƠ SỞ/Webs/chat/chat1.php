...
<body>
    ...
    <div class="a1">
        <?php 
            ...
            echo "<li><strong>$from_user:</strong> $message1 <form method='POST' action='../Comment/delete_comment.php'>
        ...
        <input type="text" placeholder="Nhập tin nhắn..." name = "message1" height="5px">
