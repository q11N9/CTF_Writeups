			...
			<div class="container text-center">
			    <form action="login.php" method="post" class="form-signin" data-ember-action="2">
					...
					<br><br>
				        ...
				        <small class="create-account text-muted">Bạn không có tài khoản? <button id="ember363" class="ember-view btn btn-sm btn-default"><a href="../register/registerHTML.php"> Đăng ký </a></button> </small>
						<button class="home"><a href="..">Web </a></button>
					</form>
		    </div>
		</div>
		<script>
